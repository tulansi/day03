        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="status" id = "txt_search_status">
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 图标  </h4>
				</div>
				<div class="modal-body">
		    	    ...
		    	    $.ajax({
		    	    	...
		    	    	success:function(res){
		    	    		if(res.success){
		    	    			var xary=new Array();
		    	    			var yary=new Array();
		    	    			res.data.forEach(function(devicetypeVo){//饼图数据处理
		    	    				xary.push(devicetypeVo.typename);
		    	    			    yary.push( {value: devicetypeVo.num, devicename: devicetypeVo.typename});
